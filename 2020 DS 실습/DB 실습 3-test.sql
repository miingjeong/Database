...
select all salary from employee where dno=5
union
...
select * from employee,department  where dname='Research' and dnumber=dno;
...
join project on pnumber=pno where pname='PorductX';
